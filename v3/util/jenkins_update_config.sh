...
CONTROL_JENKINS_OKTA_METADATA=$(etcdctl get /jenkins/control-jenkins-okta-metadata)
CONTROL_JENKINS_ADMIN_GROUP=$(etcdctl get /jenkins/control-jenkins-admin-group)
CONTROL_JENKINS_RO_GROUP=$(etcdctl get /jenkins/control-jenkins-ro-group)
